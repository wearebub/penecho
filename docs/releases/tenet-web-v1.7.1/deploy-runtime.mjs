...
const BACKUP = `/opt/tenet-demo/backups/whiteboard-1.7.1-${config.sourceCommit.slice(0,7)}`;
...
if(mode==='prepare') {
  ...
  assert.equal(manifest.tag,'tenet-web-v1.7.1'); assert.equal(manifest.sourceCommit,config.sourceCommit);
  const archiveName='Tenet-Whiteboard-runtime-1.7.1.tar';
